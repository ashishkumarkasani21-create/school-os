...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for code, school in schools.items():
            ...
            # Seed Homework — grade-appropriate titles based on classroom name
            import re as _re
            _grade_match = _re.search(r'\d+', classroom.name)
            _grade_num = int(_grade_match.group()) if _grade_match else 10
            ...
            for cs in cls_subs:
                ...
                title, desc = hw_titles.get(sub_name, (f'{sub_name} Chapter Exercise', 'Read Chapter 2 and complete the questions at the end of the section.'))
                if cs.teacher:
